...
- Cat effectiveness data：`arena/benchmarks/cat-effectiveness/sources/**` and `cases/**` for curated SkillsBench-derived gold cases; generated `runs/**` scorecards remain local evidence by default
