<div align="center">
  ...
  **会交付、可复盘、能受控进化的 IM-native AI 同事 Runtime。**
  ...
  [源码快速开始](#快速开始) · [macOS v0.2.0 Preview](https://github.com/fightheyyy/XiaoBa-CLI/releases/tag/v0.2.0) · [工作方式](#工作与进化) · [受控进化](#受控进化) · [English](README.en.md)
...
> **macOS Desktop Preview**：可下载 [XiaoBa v0.2.0](https://github.com/fightheyyy/XiaoBa-CLI/releases/tag/v0.2.0)。该 DMG 面向 Apple Silicon（arm64），包含当前八角色与受控进化主线；它采用 ad-hoc 签名、尚未 notarize，桌面启动的 CLI / Pet / IM 子服务需要系统 Node.js 18+。
