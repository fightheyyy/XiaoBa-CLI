<div align="center">
  ...
  **会交付、可复盘、能受控进化的 IM-native AI 同事 Runtime。**
  ...
  [源码快速开始](#快速开始) · [macOS v0.1.1 早期预览](https://github.com/fightheyyy/XiaoBa-CLI/releases/tag/v0.1.1) · [工作方式](#工作与进化) · [受控进化](#受控进化) · [English](README.en.md)

  <sub>v0.1.1 桌面包早于当前八角色与受控进化实现；最新能力请从源码运行。该包采用 ad-hoc 签名，尚未完成 Apple notarization。</sub>
</div>
...
> **macOS Desktop Preview**：可下载 [XiaoBa v0.1.1](https://github.com/fightheyyy/XiaoBa-CLI/releases/tag/v0.1.1) 体验早期桌面界面。该 DMG 面向 Apple Silicon（arm64），但不包含当前 `main` 的八角色与受控进化能力；最新版本请按下方步骤从源码运行。
...
| 类型 | Role | 责任 |
| --- | --- | --- |
| 执行 | EngineerCat | 代码、仓库和构建；承接明确移交的工程修复 |
...
- BrowserCat、GuiCat 和 SecretaryCat 依赖对应 driver / CLI，以及必要的安装、权限或登录状态。
