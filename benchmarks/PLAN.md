...
| [`BioBench/SPEC.md`](BioBench/SPEC.md) | 生信 trace 的领域 taxonomy、清洗状态和实现差距 |
| [`BioBench/EVALUATION.md`](BioBench/EVALUATION.md) | BioBench 的质量/效率评分、A/B、branch lane 和 verifier 设计 |
...
- [`BioBench/SPEC.md`](BioBench/SPEC.md) 的 “当前代码实现状态”
...
- [`BioBench/EVALUATION.md`](BioBench/EVALUATION.md) 的 “Verifier 设计”
...
- [`BioBench/EVALUATION.md`](BioBench/EVALUATION.md) 的 “Quality / Efficiency 双轴评估”
...
- `BioBench` 的领域细节放在 `BioBench/SPEC.md` 和 `BioBench/EVALUATION.md`；通用执行计划放在本文。
